...
const questionSchema = new mongoose.Schema(
	{
		...
		/** 0..4 for first-wave questions only; used to cap follow-ups on those slots. */
		focus_primary_index: { type: Number, default: null },
		/** For follow_up rows: which first-wave slot (0..4) this follow-up belongs to. */
		parent_focus_primary_index: { type: Number, default: null },
