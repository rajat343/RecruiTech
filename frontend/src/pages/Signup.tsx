...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to RecruiTech! Let's get started.",
      });
      setIsLoading(false);
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-hero items-center justify-center p-12 relative overflow-hidden">
        {/* Background Effects */}
        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          <p className="text-primary-foreground/70 text-lg">
            Whether you're looking for your next role or searching for top talent, RecruiTech is here to help you succeed.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-2">Join RecruiTech and unlock your potential</p>
          </div>
